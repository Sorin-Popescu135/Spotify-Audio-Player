...
public class CommandRunner {
    ...
    public static ObjectNode addAlbum(CommandInput commandInput) {
        ...
        if (user == null) {
            ...
            ((Artist) user).hasAlbumWithSameName(album, bool);
            ...
            if (bool.getBool()) {
                ...
                ((Artist) user).addAlbum(album, messageWrapper);
                message = messageWrapper.getValue();
            }
        }
    ...
    public static ObjectNode showAlbums(CommandInput commandInput) {
        ...
        for(Album album : user.getAlbums()) {
            ArrayList<String> names = ((Artist)user).showAlbumsName(album);
    ...
    public static ObjectNode printCurrentPage(CommandInput commandInput){
        ...
        if(user.getCurrentPage() == "Home"){
            message = user.printHomePage();
        }
